...
⚔️ 戦闘中: **夜哭きの梟との戦い**(ターン12)

🕳 **ボスが禁忌の詠唱中!** [PR #37](https://github.com/sawswork/asteria/pull/37) が星の理を歪めようとしている(猶予**1ターン**)。
ボスへ合計90ダメージで打ち破るか、**[PR #37](https://github.com/sawswork/asteria/pull/37) を手動でクローズして封じる**かのどちらかを——放置すると強制マージされる。

<!-- GAME:BOARD:BEGIN -->
![戦闘シーン](assets/scene.svg?v=i38-a0)

![戦況ボード](assets/board.svg?v=i38-a0)
<!-- GAME:BOARD:END -->
